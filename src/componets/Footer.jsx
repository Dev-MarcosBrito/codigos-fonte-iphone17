                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex gap-6 text-sm text-gray-400">
                            {buttonLinks.map((link, index) => (
                                <a key={index} href="#" className="hover:text-white cursor-pointer">{link}</a>
                            ))}
                        </div>
                    </div>
                    <a href="https://youtu.be/wLHOCB2U2BY?si=RF23liKS6i7txwJw" className="text-xs text-gray-500 mt-6 text-center">Site criado para fins educacionais - Aula no Youtube</a>
                </div>
